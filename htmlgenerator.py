...
for row in reader:
	...
	<title>Coronavirus in '''+district+''' | Block wise Covid-19 Tracker</title>
	<meta name="title" content="Coronavirus Outbreak in '''+district+''': Block wise Dashboard"/>
	<link rel="icon" type="image/png"  href="../../icon.png"/>
	<meta charset="utf-8">
	<meta name="description" content="An effort to track coronavirus outbreak in Bihar with graphs and tables of the number of cases by district and block.">
